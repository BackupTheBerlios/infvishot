 ...
 * @version $Id: Library.java,v 1.1 2005/04/28 16:29:19 harrym_nu Exp $
 */
public interface Library extends PluginElement {
    /**
     ...
     * <code>"*", "package.name.*", "package.name.ClassName", "resource/path/*</code>
