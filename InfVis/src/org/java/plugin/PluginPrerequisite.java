 ...
 * @version $Id: PluginPrerequisite.java,v 1.1 2005/04/28 16:29:19 harrym_nu Exp $
 */
public interface PluginPrerequisite extends PluginElement {
    /**
     * Version identifier matching mode.
     */
    String MATCH_EQUAL = "equal";
     ...
     * Version identifier matching mode.
     */
    String MATCH_COMPATIBLE = "compatible";
    
    /**
     * Version identifier matching mode.
     */
    String MATCH_GREATER_OR_EQUAL = "greater-or-equal";
