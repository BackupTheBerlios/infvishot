 ...
 * does not include information about libraries, extensions and extension points,
 * defined in this fragment, such information is available as part of plug-in,
 * to which this fragment contributes.
 * @version $Id: PluginFragment.java,v 1.1 2005/04/28 16:29:19 harrym_nu Exp $
 */
public interface PluginFragment extends Identity, Documentable {
    /**
    ...
    /**
     * @return version identifier of plug-in to which this fragment may contribute
     */
     ...
     * @return <code>true</code> if this fragment may contribute to given plug-in
     */
